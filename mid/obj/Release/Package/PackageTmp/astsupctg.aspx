...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView1" BackColor="White" CssClass="grid" GridLines="None" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" >
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="الرقم" DataNavigateUrlFormatString="updatedelesupctg.aspx?no={0}" HeaderText="تعديل و حذف" NavigateUrl="~/updatedelesupctg.aspx" Text="تعديل و حذف" />
        </Columns>
    </asp:GridView>
          </div>
</asp:Content>
