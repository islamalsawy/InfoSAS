...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div style="float:left; width:100%;margin-right:30px;">
        <table class="grid">
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="الانشطه التجاريه"></asp:Label></td>
                <td>
    ...
    <asp:GridView ID="GridView1" BackColor="White" CssClass="grid" GridLines="None" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="الرقم" DataNavigateUrlFormatString="updatedelenutrbusn.aspx?no={0}" HeaderText="تعديل و حذف" NavigateUrl="~/updatedelenutrbusn.aspx" Text="تعديل و حذف" />
        </Columns>
    </asp:GridView>
         </div>
</asp:Content>
