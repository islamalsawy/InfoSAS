...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <div style="float:left; width:100%;margin-right:30px;">
        <table class="grid">
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="المناطق بالمدن"></asp:Label></td>
                <td>
    ...
    <asp:GridView ID="GridView1" BackColor="White" CssClass="grid" GridLines="None" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="رقم_المنطقة" DataNavigateUrlFormatString="updatedelea_area.aspx?no={0}" HeaderText="تعديل و حذف" NavigateUrl="~/updatedelea_area.aspx" Text="تعديل و حذف" />
        </Columns>
    </asp:GridView>
    </div>
</asp:Content>
