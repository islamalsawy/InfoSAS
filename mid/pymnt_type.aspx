...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="grid">
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="طريقة دفع الراتب"></asp:Label></td>
            <td>
    ...
    <asp:GridView ID="GridView1" BackColor="White" CssClass="grid" GridLines="None" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="الرقم" DataNavigateUrlFormatString="updatedele_paymnt_type.aspx?no={0}" HeaderText="تعديل و حذف" NavigateUrl="~/updatedele_paymnt_type.aspx" Text="تعديل و حذف" />
        </Columns>
    </asp:GridView>
    </div>
